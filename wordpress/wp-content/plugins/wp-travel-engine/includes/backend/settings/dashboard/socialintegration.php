...
<?php $display_class = isset( $enable_social_login ) && 'yes' === $enable_social_login ? 'show' : 'hide'; ?>
	<div data-social-login-section class="wpte-login-settings <?php wptravelengine_hidden_class( isset( $enable_social_login ) && 'yes' !== $enable_social_login, true ); ?>" login-integration="sociallogin">
	<?php
	foreach ( $social_networking_sites as $social_logins => $social_network ) {
		...
		class="wpte-field wpte-field-wrapper <?php wptravelengine_hidden_class( isset( $wp_travel_engine_settings[ "enable_{$social_network}_login" ] ) && 'yes' !== $wp_travel_engine_settings[ "enable_{$social_network}_login" ], true ); ?> login-integration="<?php echo $social_network; ?>">
