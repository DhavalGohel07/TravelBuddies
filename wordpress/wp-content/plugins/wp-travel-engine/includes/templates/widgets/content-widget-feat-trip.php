		...
		<div class="category-trip-detail-wrap">
			...
			<div class="category-trip-desti">
				...
				<span class="category-trip-dur">
					...
					<?php
						wte_get_template( 'components/content-trip-card-duration.php', compact( 'trip_duration_unit', 'trip_duration', 'trip_duration_nights', 'set_duration_type' , 'featured_widget' ) );
					?>
				</span>
				<?php endif; ?>
				<?php 
